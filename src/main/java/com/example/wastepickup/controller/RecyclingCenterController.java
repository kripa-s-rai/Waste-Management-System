...
import com.example.wastepickup.strategy.WasteProcessor;
import com.example.wastepickup.strategy.WasteProcessorFactory;
...
public class RecyclingCenterController {
   ...
   @PostMapping("/process/{id}")
    public String processWaste(
        ...
        if (pickup != null) {
            WasteProcessor processor = WasteProcessorFactory.getProcessor(category);
            processor.process(pickup, processedBy);
